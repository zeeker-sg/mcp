...
_SEARCH_DESCRIPTION = (
    ...
    "have a matching column. Heavy text columns are never inlined; instead each "
    "row carries match_context, a short quotation-length extract around the "
    "match showing why the row matched (from the best-matching passage on "
    "body-text matches; null when unavailable). "
